...
# Datensatz laden
data <- read_xlsx("SHARE_PRICES_OECD_3.xlsx")
...
write_xlsx(DELTA_QOQ_AVG_2020_INDUSTRY, "Tabelle_6.xlsx")
...
heterogenitaetsfaktoren <- read_xlsx("Heterogenitaetsfaktoren.xlsx")
library(plyr)
